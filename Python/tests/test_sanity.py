...
def test_sanity_original_examples(k, iterations, i):
    ...
    get_and_assert_new_centroids(k, iterations, epsilon, input_filepath, output_filepath)
...
def get_and_assert_new_centroids(k, iterations, epsilon, input_filepath, output_filepath):
